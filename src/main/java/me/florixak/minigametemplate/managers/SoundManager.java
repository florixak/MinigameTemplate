...
//		xSound.play(player.getLocation(), volume, pitch);
	...
	public void playLevelUpSound(final Player player) {
		final XSound sound = getSound(GameValues.SOUNDS.LEVEL_UP_SOUND);
		playSound(sound, player, GameValues.SOUNDS.LEVEL_UP_VOLUME, GameValues.SOUNDS.LEVEL_UP_PITCH);
	}
